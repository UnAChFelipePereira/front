...
export class HacerQuintafase implements OnInit {
  ...
  submitAnswers(f: NgForm) {
    ...
    this.faseId = "Quinta Fase";
    this.Nombre_Curso = this.curso.nombre_curso;
    // Comparar las respuestas seleccionadas con las correctas
    this.answeredQuestions['pregunta1'] = this.selectedAnswers['pregunta1'] === this.curso['respuestacorrectap1pt5'];
    this.answeredQuestions['pregunta2'] = this.selectedAnswers['pregunta2'] === this.curso['respuestacorrectap2pt5'];
    this.answeredQuestions['pregunta3'] = this.selectedAnswers['pregunta3'] === this.curso['respuestacorrectap3pt5'];
    this.answeredQuestions['pregunta4'] = this.selectedAnswers['pregunta4'] === this.curso['respuestacorrectap4pt5'];
    this.answeredQuestions['pregunta5'] = this.selectedAnswers['pregunta5'] === this.curso['respuestacorrectap5pt5'];
  ...
  goToNextPhase(cursoId: string) {
    ...
    this.router.navigate(['/mi_progreso']);
  }
  ...
  downloadFile() {
    const url = `http://localhost:3000/uploads/${encodeURIComponent(this.curso.archivo_pt5Nombre)}`;
