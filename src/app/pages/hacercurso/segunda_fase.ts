...
export class HacerSegundafase implements OnInit {
  ...
  submitAnswers(f: NgForm) {
    ...
    this.faseId = "Segunda Fase";
    this.Nombre_Curso = this.curso.nombre_curso;
    // Comparar las respuestas seleccionadas con las correctas
    this.answeredQuestions['pregunta1'] = this.selectedAnswers['pregunta1'] === this.curso['respuestacorrectap1pt2'];
    this.answeredQuestions['pregunta2'] = this.selectedAnswers['pregunta2'] === this.curso['respuestacorrectap2pt2'];
    this.answeredQuestions['pregunta3'] = this.selectedAnswers['pregunta3'] === this.curso['respuestacorrectap3pt2'];
    this.answeredQuestions['pregunta4'] = this.selectedAnswers['pregunta4'] === this.curso['respuestacorrectap4pt2'];
    this.answeredQuestions['pregunta5'] = this.selectedAnswers['pregunta5'] === this.curso['respuestacorrectap5pt2'];
  ...
  downloadFile() {
    const url = `http://localhost:3000/uploads/${encodeURIComponent(this.curso.archivo_pt2Nombre)}`;
